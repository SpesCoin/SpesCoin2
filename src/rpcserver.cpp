...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop spescoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "spescoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* spescoin features */
        {"spescoin", "masternode", &masternode, true, true, false},
        {"spescoin", "listmasternodes", &listmasternodes, true, true, false},
        {"spescoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"spescoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"spescoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"spescoin", "masternodedebug", &masternodedebug, true, true, false},
        {"spescoin", "startmasternode", &startmasternode, true, true, false},
        {"spescoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"spescoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"spescoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"spescoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"spescoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"spescoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"spescoin", "mnsync", &mnsync, true, true, false},
        {"spescoin", "spork", &spork, true, true, false},
        {"spescoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"spescoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
        ...
        {"wallet", "getaccountkeypair", &getaccountkeypair, true, false, true},
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use spescoind, or the -server option to spescoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> spescoin-cli " + methodname + " " + args + "\n";
}
