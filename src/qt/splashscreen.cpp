...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("SPESCOIN Wallet Core");
    ...
    QString copyrightTextspescoin = QChar(0xA9) + QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The SPESCOIN Core developers"));
    ...
    pixPaint.setPen(QColor(255, 250, 230));
    ...
    pixPaint.drawText(paddingLeft+140, paddingTop + titleCopyrightVSpace + 42, copyrightTextspescoin);
