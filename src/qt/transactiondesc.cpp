...
QString TransactionDesc::toHTML(CWallet* wallet, CWalletTx& wtx, TransactionRecord* rec, int unit)
{
    ...
    //QString txIDWithHref = "<a href=\"http://explorer.myspes.org/transactions/?transaction_hash=" + rec->getTxID() + "&view=public" + "\">" + rec->getTxID() + "</a>";
	QString txIDWithHref = "<a href=\"http://explorer.myspes.org/tx/" + rec->getTxID() + "\">" + rec->getTxID() + "</a>";
    strHTML += "<b>" + tr("Transaction ID") + ":</b> " + txIDWithHref + "<br>";
    strHTML += "<b>" + tr("Output index") + ":</b> " + QString::number(rec->getOutputIndex()) + "<br>";

    // Message from normal spescoin:URI (spescoin:XyZ...?message=example)
