...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
		...
		if (nSporkID == SPORK_11_DEVFUND_FEE) r = SPORK_11_DEVFUND_FEE_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_11_DEVFUND_FEE") return SPORK_11_DEVFUND_FEE;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_11_DEVFUND_FEE) return "SPORK_11_DEVFUND_FEE";
