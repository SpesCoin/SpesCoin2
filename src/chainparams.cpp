...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(12296, uint256("15f7827edab8944cbb34e19f5a37300b459590c3ebeb40f3485df91e6321f362"))
	(23447, uint256("1f281654ab7e38b191de5dd9ad39265191de8dfc09df4c55eb9f2de2e349ba23"))	
	(40133, uint256("533c303495ecc4053b8c1c241d51495534958423c10c1148c1df1c3708f62483"))
    ;

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1573717948, // * UNIX timestamp of last checkpoint block
    81967,      // * total number of transactions between genesis and last checkpoint
                //   (the tx=... number in the SetBestChain debug.log lines)
    2276        // * estimated number of transactions per day after checkpoint
};

static Checkpoints::MapCheckpoints mapCheckpointsTestnet = boost::assign::map_list_of(0, uint256("0x001"));
static const Checkpoints::CCheckpointData dataTestnet = {&mapCheckpointsTestnet, 1570553000, 0, 250};

static Checkpoints::MapCheckpoints mapCheckpointsRegtest = boost::assign::map_list_of(0, uint256("0x001"));
static const Checkpoints::CCheckpointData dataRegtest = {&mapCheckpointsRegtest, 1567570700, 0, 0};
...
public:
    CMainParams()
    {
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1570536000; // Thu, 7 Feb 2019 08:02:03 GMT
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1567484300; // Thu, 7 Feb 2019 08:02:03 GMT
        genesis.nNonce = 0;
